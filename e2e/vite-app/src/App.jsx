// Shared test tree (Task 12) — kept identical in e2e/next-app/app/page.jsx so
...
// just this subtree's outerHTML/innerHTML from the rendered container.
    ...
    children: [
      Div({
        ...
        onClick: () => {
          ...
          // dynamic; this render never invokes it.
        },
        children: [
